                ...
                <form action="{{ route('ternak.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="seri_burung" id="seri_burung"
                            placeholder="Seri Burung" value="{{ old('seri_burung') }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_netas" id="tanggal_netas"
                            placeholder="Tanggal Netas" value="{{ old('tanggal_netas') }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="seri_indukan_jantan" id="seri_indukan_jantan" placeholder="Seri Indukan Jantan" value="{{ old('seri_indukan_jantan') }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="seri_indukan_betina" id="seri_indukan_betina" placeholder="Seri Indukan Jantan" value="{{ old('seri_indukan_betina') }}">
                    </div>
